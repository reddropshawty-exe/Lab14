...
public class Car : IInit, IComparable, ICloneable, GetKey
{
    ...
    public void ShowAll()
    {
        ...
        //Console.Write(" Год выпуска: " + Year);
        //Console.Write(" Цвет: " + Color);
        //Console.Write(" Стоимость: " + Cost);
        //Console.Write(" Дорожный просвет: " + GroundClearance);

        //if (this is PassengerCar)
        //{
        //    Console.WriteLine("Количество мест: " + ((PassengerCar)this).Seats);
        //    Console.WriteLine("Максимальная скорость: " + ((PassengerCar)this).MaxSpeed);
        //}
        //else if (this is SUV)
        //{
        //    Console.WriteLine("Полный привод: " + ((SUV)this).Fwd);
        //    Console.WriteLine("Тип бездорожья: " + ((SUV)this).OffroadType);
        //}
        //else if (this is Truck)
        //{
        //    Console.WriteLine("Грузоподъемность: " + ((Truck)this).LoadCapacity);
        //}
    }
    ...
    static string[] brands = { "Mercedes-Benz", "Audi", "Renault", "Ford", "Opel", "Lada", "BMW", "Skoda", "Jaguar", "Porsche", "Kia" };
    ...
    public void RandomInit()
        {
            ...
            year = rnd.Next(1990, 2025);
            color = colours[rnd.Next(colours.Length)];
            cost = rnd.Next(300000, 10000000);
            groundClearance = rnd.Next(10, 50)/10;
        }
    ...
    public void Init()
    {
        ...
        cost = EntryDouble("стоимость автомобиля", 1500000);
